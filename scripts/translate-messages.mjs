...
const MANUAL_OVERRIDES = {
  ...
  "app.studio.usageSummary": {
    es: "{remaining} de {limit} créditos restantes · este video usa {duration}",
    zh: "剩余 {remaining}/{limit} 积分 · 此视频将消耗 {duration} 积分",
    ja: "残り {remaining}/{limit} クレジット · この動画は {duration} を使用します",
    ko: "{limit} 크레딧 중 {remaining} 크레딧이 남아 있습니다 · 이 영상은 {duration} 크레딧을 사용합니다",
    pt: "{remaining} de {limit} créditos restantes · este vídeo usa {duration} créditos",
    id: "{remaining} dari {limit} kredit tersisa · video ini menggunakan {duration} kredit",
    vi: "Còn {remaining}/{limit} tín dụng · video này dùng {duration} tín dụng",
    th: "เหลือ {remaining}/{limit} เครดิต · วิดีโอนี้ใช้ {duration} เครดิต",
  },
  ...
  "marketing.landing.marquee.seedance": {
    es: "Seedance 2.0 · Fast · Mini",
    zh: "Seedance 2.0 · Fast · Mini",
    ja: "Seedance 2.0 · Fast · Mini",
    ko: "Seedance 2.0 · Fast · Mini",
    pt: "Seedance 2.0 · Fast · Mini",
    id: "Seedance 2.0 · Fast · Mini",
    vi: "Seedance 2.0 · Fast · Mini",
  ...
  "marketing.metadata.models.description": {
    es: "Elige tu modelo de renderizado en Studio: Seedance 2.0, 2.0 Fast o 2.0 Mini, con Seedance 2.5 próximamente. Cada toma recibe los ajustes que mejor la renderizan.",
    zh: "在 Studio 中选择渲染模型——Seedance 2.0、2.0 Fast 或 2.0 Mini，Seedance 2.5 即将推出。每个镜头都会获得最佳渲染设置。",
    ja: "Studio でレンダリングモデルを選択 — Seedance 2.0、2.0 Fast、2.0 Mini。Seedance 2.5 も近日登場。各ショットに最適な設定が適用されます。",
    ko: "Studio에서 렌더링 모델을 선택하세요 — Seedance 2.0, 2.0 Fast, 2.0 Mini. Seedance 2.5는 곧 출시됩니다. 각 숏에 가장 적합한 설정이 적용됩니다.",
    pt: "Escolha seu modelo de renderização no Studio — Seedance 2.0, 2.0 Fast ou 2.0 Mini, com Seedance 2.5 em breve. Cada take recebe as configurações que melhor o renderizam.",
    id: "Pilih model render Anda di Studio — Seedance 2.0, 2.0 Fast, atau 2.0 Mini, dengan Seedance 2.5 segera hadir. Setiap shot mendapat pengaturan yang merendernya paling baik.",
    vi: "Chọn mô hình render trong Studio — Seedance 2.0, 2.0 Fast hoặc 2.0 Mini, Seedance 2.5 sắp ra mắt. Mỗi cảnh đều được thiết lập để render đẹp nhất.",
  ...
  "marketing.models.cards.fast.desc": {
    es: "La misma familia ajustada para velocidad — renders más rápidos a un menor costo en créditos, hasta 720p.",
    zh: "同系列的速度优化版——渲染更快、积分成本更低，最高 720p。",
    ja: "同じファミリーを速度重視にチューニング — より速いレンダリングをより低いクレジットコストで。最大720p。",
    ko: "같은 패밀리를 속도에 맞게 튜닝 — 더 낮은 크레딧 비용으로 더 빠른 렌더링, 최대 720p.",
    pt: "A mesma família ajustada para velocidade — renders mais rápidos com menor custo em créditos, até 720p.",
    id: "Keluarga yang sama, disetel untuk kecepatan — render lebih cepat dengan biaya kredit lebih rendah, hingga 720p.",
    vi: "Cùng gia đình nhưng tối ưu cho tốc độ — render nhanh hơn với chi phí tín dụng thấp hơn, lên đến 720p.",
    th: "ตระกูลเดียวกันปรับมาเพื่อความเร็ว — เรนเดอร์ไวขึ้นด้วยต้นทุนเครดิตที่ต่ำกว่า สูงสุด 720p",
  },
  ...
  "marketing.models.cards.mini.desc": {
    es: "El nivel más ligero — borradores e iteraciones al menor costo en créditos por render, hasta 720p.",
    zh: "最轻量的一档——以每次渲染最低的积分成本打草稿、做迭代，最高 720p。",
    ja: "最軽量ティア — 下書きと試行を1レンダリングあたり最小のクレジットコストで。最大720p。",
    ko: "가장 가벼운 티어 — 렌더링당 가장 낮은 크레딧 비용으로 초안을 만들고 반복하세요. 최대 720p.",
    pt: "O nível mais leve — rascunhe e itere com o menor custo em créditos por render, até 720p.",
    id: "Tingkat paling ringan — buat draf dan iterasi dengan biaya kredit terendah per render, hingga 720p.",
    vi: "Gói nhẹ nhất — nháp và lặp lại với chi phí tín dụng thấp nhất mỗi lần render, lên đến 720p.",
    th: "ระดับที่เบาที่สุด — ร่างและปรับซ้ำด้วยต้นทุนเครดิตต่ำสุดต่อการเรนเดอร์ สูงสุด 720p",
  },
  ...
  "marketing.models.header.subtitle": {
    es: "El selector de modelos de Studio pone la familia Seedance a tu alcance — y tus guiones se conservan a medida que llegan nuevos modelos.",
    zh: "Studio 的模型选择器让你随心选用 Seedance 系列——新模型到来时，你的脚本依然可用。",
    ja: "Studio のモデルピッカーで Seedance ファミリーを自在に選択できます。新しいモデルが登場してもスクリプトはそのまま引き継がれます。",
    ko: "Studio의 모델 선택기로 Seedance 패밀리를 자유롭게 고를 수 있습니다. 새 모델이 나와도 스크립트는 그대로 이어집니다.",
    pt: "O seletor de modelos do Studio coloca a família Seedance ao seu alcance — e seus roteiros continuam valendo quando novos modelos chegam.",
    id: "Pemilih model Studio menyediakan keluarga Seedance di ujung jari Anda — dan skrip Anda tetap terbawa saat model baru tiba.",
    vi: "Bộ chọn mô hình trong Studio đưa cả gia đình Seedance đến tầm tay bạn — và kịch bản của bạn vẫn dùng được khi có mô hình mới.",
    th: "ตัวเลือกโมเดลใน Studio วางตระกูล Seedance ไว้ในมือคุณ — และสคริปต์ของคุณยังใช้ต่อได้เมื่อมีโมเดลใหม่",
  },
  ...
  "marketing.pricing.faq.a5": {
    es: "Tú eliges el modelo de renderizado en Studio: Seedance 2.0 para la máxima calidad, o Seedance 2.0 Fast y 2.0 Mini cuando importan más la velocidad y el costo. Seedance 2.5 llegará pronto.",
    zh: "渲染模型由你在 Studio 中选择：追求最高画质选 Seedance 2.0，更看重速度和成本则选 Seedance 2.0 Fast 和 2.0 Mini。Seedance 2.5 即将推出。",
    ja: "レンダリングモデルは Studio で選択できます。最高品質なら Seedance 2.0、速度とコストを重視するなら Seedance 2.0 Fast と 2.0 Mini。Seedance 2.5 も近日登場予定です。",
    ko: "렌더링 모델은 Studio에서 직접 선택합니다. 최고 품질은 Seedance 2.0, 속도와 비용이 더 중요하다면 Seedance 2.0 Fast와 2.0 Mini를 선택하세요. Seedance 2.5도 곧 출시됩니다.",
    pt: "Você escolhe o modelo de renderização no Studio: Seedance 2.0 para a máxima qualidade, ou Seedance 2.0 Fast e 2.0 Mini quando velocidade e custo importam mais. Seedance 2.5 chega em breve.",
    id: "Anda memilih model render di Studio: Seedance 2.0 untuk kualitas terbaik, atau Seedance 2.0 Fast dan 2.0 Mini saat kecepatan dan biaya lebih penting. Seedance 2.5 segera hadir.",
    vi: "Bạn tự chọn mô hình render trong Studio: Seedance 2.0 cho chất lượng cao nhất, hoặc Seedance 2.0 Fast và 2.0 Mini khi tốc độ và chi phí quan trọng hơn. Seedance 2.5 sắp ra mắt.",
    th: "คุณเลือกโมเดลเรนเดอร์ได้ใน Studio: Seedance 2.0 เพื่อคุณภาพสูงสุด หรือ Seedance 2.0 Fast และ 2.0 Mini เมื่อความเร็วและต้นทุนสำคัญกว่า Seedance 2.5 จะมาเร็วๆ นี้",
  },
