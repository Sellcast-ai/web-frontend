...
const MANUAL_OVERRIDES = {
  ...
  "app.jobs.working.shotsDescription": {
    es: "Tu storyboard está aprobado. Lumi está preparando las referencias de tomas y los recursos de renderizado, y cada toma aparece aquí en cuanto está lista.",
    zh: "你的分镜已批准。Lumi 正在准备镜头参考图和渲染素材，每个镜头准备好后就会显示在这里。",
    ja: "ストーリーボードは承認済みです。Lumi がショット参照とレンダリング素材を準備しており、各ショットは完成しだいここに表示されます。",
    ko: "스토리보드가 승인되었습니다. Lumi가 샷 참조와 렌더링 에셋을 준비하고 있으며, 각 샷은 준비되는 대로 여기에 표시됩니다.",
    pt: "Seu storyboard foi aprovado. A Lumi está preparando as referências das tomadas e os recursos de renderização, e cada tomada aparece aqui assim que fica pronta.",
    id: "Storyboard Anda sudah disetujui. Lumi sedang menyiapkan referensi shot dan aset render, dan setiap shot muncul di sini begitu siap.",
    vi: "Storyboard của bạn đã được duyệt. Lumi đang chuẩn bị ảnh tham chiếu cho cảnh và tài nguyên render, và từng cảnh sẽ hiện ở đây ngay khi sẵn sàng.",
    th: "สตอรี่บอร์ดของคุณได้รับอนุมัติแล้ว Lumi กำลังเตรียมภาพอ้างอิงของช็อตและไฟล์สำหรับเรนเดอร์ และแต่ละช็อตจะปรากฏที่นี่เมื่อพร้อม",
  },
