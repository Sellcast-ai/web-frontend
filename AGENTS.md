...
Add a CTA through that primitive, never a bare `href="/signup"`; the header and footer are server components that read `hasSession` directly (client context can't reach them) and swap the same way.
