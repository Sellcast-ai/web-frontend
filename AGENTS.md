...
- Catalogs: `messages/<locale>.json` at repo root, `en.json` is the source of truth. All 9 UI catalogs (`en, es, zh, ja, ko, pt, id, vi, th`) mirror the same key/placeholder structure; `src/i18n/messages.test.ts` enforces parity.
